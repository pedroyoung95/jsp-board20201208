...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="${pageContext.request.contextPath }/index.jsp">중앙프로젝트</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
       ...
       <u:isLogin>
	       <ul class="navbar-nav">
	       	<li class="nav-item">
	       		<a href="${pageContext.request.contextPath }/changePwd.do" class="nav-link"><i class="fas fa-key"></i>변경</a>
	       	</li>
	       	<li class="nav-item">
	       		<a href="${pageContext.request.contextPath }/removeMember.do" class="nav-link"><i class="fas fa-users-slash"></i>탈퇴</a>
	       	</li>
	       	<li class="nav-item">
